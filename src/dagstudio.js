...
document.onload = (function(d3, saveAs, Blob, undefined){
    ...
    var DagStudio = function(svg, nodes, edges){
        ...
        thisGraph.state = {
            ...
            metadataboxExpand: true,
            metaboxWidth: 180, //[collapsed, default expanded]
    ...
    // initial node data
    var nodes = [{type: 'Convolution', id: 'conv1', param: '', type_param: '', x: 100, y: 100},
                 {type: 'Pooling',     id: 'pool1', param: '', type_param: '', x: 100, y: 300},
                 {type: 'Fooling',     id: 'fool1', param: '', type_param: '', x: 200, y: 200},
        {type: 'kooling',     id: 'pool2', param: '', type_param: '', x: 300, y: 300}];
